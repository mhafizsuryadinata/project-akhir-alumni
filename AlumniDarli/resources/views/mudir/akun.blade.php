...
<section class="hero-akun fade-in-akun">
    <div class="container">
        ...
        <p>Kelola informasi identitas dan keamanan akun pimpinan pondok Anda</p>
    </div>
</section>
        ...
        <div class="card-profile fade-in-akun">
            <div class="profile-section-akun">
                <div class="position-relative d-inline-block mb-4">
                    <img src="{{ $user->foto ? asset('storage/' . $user->foto) : asset('assets-mudir/images/profile/user-1.jpg') }}" 
                ...
                <p class="profile-role-akun">Pimpinan Pondok</p>
            ...
            <div class="tab-pane fade show active" id="profile">
                <div class="card card-profile border-0 shadow-sm">
                    <div class="card-body p-4">
                        <form action="{{ route('mudir.akun.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-section-akun">
                                <div class="section-title-akun">
                                    <i class="fas fa-id-card"></i> Identitas Pimpinan
                                </div>
                                <div class="row g-3">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="email" name="email" class="form-control form-control-akun" value="{{ old('email', $user->email) }}" placeholder="pimpinan@example.com">
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-12">
                                        <label class="form-label fw-bold">Bio / Pesan Pimpinan</label>
                                        <textarea name="bio" class="form-control form-control-akun" rows="3" placeholder="Ceritakan sedikit tentang Anda atau visi Anda...">{{ old('bio', $user->bio) }}</textarea>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="tab-pane fade" id="password">
                <div class="card card-profile border-0 shadow-sm">
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('mudir.akun.password') }}" method="POST">
                            @csrf
                            <div class="mb-3">
