...
<div class="row g-4 page-content">
    ...
    <div class="col-12 animate-box" style="animation-delay: 0.1s">
        <div class="card overflow-hidden border-0 page-hero">
            <div class="card-body p-4 position-relative" style="background: linear-gradient(135deg, var(--primary-blue) 0%, var(--secondary-blue) 100%);">
        ...
        <div class="collapse mb-4" id="tambahAlumniForm">
            <div class="card glass-card">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('mudir.alumni.simpan') }}" method="POST">
                        @csrf
                        <div class="row g-3">
                            <div class="col-md-6">
        ...
        <div class="card glass-card">
            <div class="card-header d-flex justify-content-between align-items-center p-4">
                ...
                <div class="col-md-4 text-md-end mt-3 mt-md-0">  
                    <button class="btn btn-primary px-4 py-2 rounded-3 shadow-sm" data-bs-toggle="collapse" data-bs-target="#tambahAlumniForm">
            ...
            <div class="card-body p-0">
                ...
                @if($errors->any())
                <div class="mx-4 mt-3 alert alert-danger alert-dismissible fade show border-0 shadow-sm rounded-3" role="alert">
                    <ul class="mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                        ...
                                        <div class="me-3 position-relative">
                                            ...
                                            @else
                                                <div class="rounded-circle bg-light-blue text-primary d-flex align-items-center justify-content-center" style="width: 48px; height: 48px; border: 2px solid var(--white);">
                                                    <iconify-icon icon="solar:user-bold-duotone" class="fs-4"></iconify-icon>
                                                </div>
                                            @endif
                                ...
                                <td>
                                    ...
                                    <div class="small text-muted"><iconify-icon icon="solar:user-id-bold-duotone" class="me-1"></iconify-icon>{{ $a->username }}</div>
                                </td>
                                <td>
                                    <div class="fw-700 text-dark small mb-1"><iconify-icon icon="solar:case-bold-duotone" class="text-primary me-2"></iconify-icon>{{ $a->pekerjaan ?? '-' }}</div>
                                    <div class="text-muted small"><iconify-icon icon="solar:map-point-bold-duotone" class="text-danger me-2"></iconify-icon>{{ $a->lokasi ?? '-' }}</div>
                                    @if($a->no_hp)
                                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $a->no_hp) }}" target="_blank" class="badge bg-light-success text-success mt-2 py-2 px-3 rounded-pill text-decoration-none" style="background: rgba(40,167,69,0.1);">
                                            <iconify-icon icon="logos:whatsapp-icon" class="me-2"></iconify-icon>{{ $a->no_hp }}
                                        </a>
                                    @endif
                                </td>
                                <td class="ps-0">
                                    <div class="d-flex justify-content-center gap-2">
                                        <a href="{{ route('mudir.alumni.edit', $a->id_user) }}" class="btn btn-sm btn-icon bg-light-warning text-warning rounded-pill" 
                                        ...
                                        <span data-bs-toggle="tooltip" data-bs-placement="top" title="Hapus Alumni">
                                            <button type="button" class="btn btn-sm btn-icon bg-light-danger text-danger rounded-pill" 
                                                    ...
                                                    onclick="setDeleteAction('{{ route('mudir.alumni.hapus', $a->id_user) }}')">
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
            <div class="modal-body p-4 text-center">
                <div class="mb-3">
                    <iconify-icon icon="solar:danger-triangle-bold-duotone" class="text-danger" style="font-size: 3.5rem; opacity: 0.8;"></iconify-icon>
                </div>
...
<style>
    ...
    .bg-light-warning { background: rgba(255, 193, 7, 0.12); }
    .bg-light-danger { background: rgba(220, 53, 69, 0.12); }
